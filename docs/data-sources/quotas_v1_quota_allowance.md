---
page_title: "nebius_quotas_v1_quota_allowance Data Source - nebius"
description: |-
...
# nebius_quotas_v1_quota_allowance Data Source
...
- `by_name_in_region` (Attributes) :

   Gets a quota allowance for a Tenant or Project by container ID, region, and name.
   
   #### Inner value description
   
   Request to get a quota allowance by container, name, and region. (see [below for nested schema](#nestedatt--by_name_in_region))
...
<a id="nestedatt--by_name_in_region"></a>
