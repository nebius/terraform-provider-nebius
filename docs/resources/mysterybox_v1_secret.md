---
page_title: "nebius_mysterybox_v1_secret Resource - nebius"
description: |-
  
---

# nebius_mysterybox_v1_secret Resource
...
- `secret_version` (Attributes) :
   ...
   operations. (see [below for nested schema](#nestedatt--secret_version))
...
<a id="nestedatt--secret_version"></a>
### Nested Schema for `secret_version`
...
- `payload` (Attributes List) :
   ...
   Represents the secret's content as key-value pair. (see [below for nested schema](#nestedatt--secret_version--payload))
- `set_primary` (Boolean)

<a id="nestedatt--secret_version--payload"></a>
### Nested Schema for `secret_version.payload`
...
- `secret_version` (Attributes) :
   ...
   Secret's version specification, defines the secret version, including its payload. This parameter must be specified only during create
   operations. (see [below for nested schema](#nestedatt--sensitive--secret_version))
...
<a id="nestedatt--sensitive--secret_version"></a>
### Nested Schema for `sensitive.secret_version`
...
- `payload` (Attributes List, [Write-only](https://developer.hashicorp.com/terraform/language/resources/ephemeral#write-only-arguments)) :
   ...
   Represents the secret's content as key-value pair. (see [below for nested schema](#nestedatt--sensitive--secret_version--payload))

<a id="nestedatt--sensitive--secret_version--payload"></a>
### Nested Schema for `sensitive.secret_version.payload`
