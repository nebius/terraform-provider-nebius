...
func (r *serviceDisk) DataSourceSchema() schema.Schema {
	ret := schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"source_image_family": schema.StringAttribute{
				Computed:            true,
...
func (r *serviceDisk) ResourceSchema() schema1.Schema {
	ret := schema1.Schema{
		Attributes: map[string]schema1.Attribute{
			...
			"source_image_family": schema1.StringAttribute{
				Validators: []validator.String{
					validators.OneofValidator([]string{
						"source_image_id",
						"source_image_family",
...
func (r *serviceDisk) Read(ctx context.Context, id string) (*v1.ResourceMetadata, proto.Message, proto.Message, *requestcontext.Context, error) {
	service := v1alpha11.NewDiskService(r.provider.SDK())
	req := &v1alpha1.GetDiskRequest{
		Id: id,
	}
...
func (r *serviceDisk) Create(ctx context.Context, metadata *v1.ResourceMetadata, spec proto.Message, wellKnownID string) (string, *requestcontext.Context, error) {
	service := v1alpha11.NewDiskService(r.provider.SDK())
	reqCtx := &requestcontext.Context{}
	specTyped, ok := spec.(*v1alpha1.DiskSpec)
	if !ok {
		return "", reqCtx, fmt.Errorf("wrong spec message type %q, expecting nebius.compute.v1alpha1.DiskSpec", spec.ProtoReflect().Descriptor().FullName())
	}
	req := &v1alpha1.CreateDiskRequest{
		Spec:     specTyped,
		Metadata: metadata,
	}
...
func (r *serviceDisk) Update(ctx context.Context, metadata *v1.ResourceMetadata, spec proto.Message) (*requestcontext.Context, error) {
	...
	req := &v1alpha1.UpdateDiskRequest{
		Spec:     specTyped,
		Metadata: metadata,
	}
...
func (r *serviceDisk) Delete(ctx context.Context, id string) (*requestcontext.Context, error) {
	reqCtx := &requestcontext.Context{}
	req := &v1alpha1.DeleteDiskRequest{
		Id: id,
	}
	service := v1alpha11.NewDiskService(r.provider.SDK())
