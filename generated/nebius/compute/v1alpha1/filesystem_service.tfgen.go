...
func (r *serviceFilesystem) GetName() string {
	return "compute_v1alpha1_filesystem"
}
	...
	ret := schema1.Schema{
		Attributes: map[string]schema1.Attribute{
			...
			"type": schema1.StringAttribute{
				Validators: []validator.String{
					validators.EnumValidator(v1alpha1.FilesystemSpec_FilesystemType_value),
				},
				Required:            true,
				MarkdownDescription: ":\n\n   #### Supported values\n   \n   Possible values:\n   \n   - `UNSPECIFIED`\n   - `NETWORK_SSD` - the list of available types will be clarified later, it is not final version\n   - `NETWORK_HDD`\n   - `WEKA`\n   - `VAST`\n   \n",
				PlanModifiers: []planmodifier.String{
...
func (r *serviceFilesystem) StatusMessage() proto.Message {
	return &v1alpha1.FilesystemStatus{}
}
...
func (r *serviceFilesystem) SpecMessage() proto.Message {
	return &v1alpha1.FilesystemSpec{}
}
...
func (r *serviceFilesystem) Read(ctx context.Context, id string) (*v1.ResourceMetadata, proto.Message, proto.Message, *requestcontext.Context, error) {
	service := v1alpha11.NewFilesystemService(r.provider.SDK())
	req := &v1alpha1.GetFilesystemRequest{
		Id: id,
	}
...
func (r *serviceFilesystem) Create(ctx context.Context, metadata *v1.ResourceMetadata, spec proto.Message, wellKnownID string) (string, *requestcontext.Context, error) {
	service := v1alpha11.NewFilesystemService(r.provider.SDK())
	reqCtx := &requestcontext.Context{}
	specTyped, ok := spec.(*v1alpha1.FilesystemSpec)
	if !ok {
		return "", reqCtx, fmt.Errorf("wrong spec message type %q, expecting nebius.compute.v1alpha1.FilesystemSpec", spec.ProtoReflect().Descriptor().FullName())
	}
	req := &v1alpha1.CreateFilesystemRequest{
		Spec:     specTyped,
		Metadata: metadata,
	}
...
func (r *serviceFilesystem) Update(ctx context.Context, metadata *v1.ResourceMetadata, spec proto.Message) (*requestcontext.Context, error) {
	...
	req := &v1alpha1.UpdateFilesystemRequest{
		Spec:     specTyped,
		Metadata: metadata,
	}
...
func (r *serviceFilesystem) Delete(ctx context.Context, id string) (*requestcontext.Context, error) {
	reqCtx := &requestcontext.Context{}
	req := &v1alpha1.DeleteFilesystemRequest{
		Id: id,
	}
	service := v1alpha11.NewFilesystemService(r.provider.SDK())
